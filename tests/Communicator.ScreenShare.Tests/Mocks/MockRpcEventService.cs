...
public class MockRpcEventService : IRpcEventService
{
    ...
    public void TriggerCanvasUpdateReceived(byte[] data) => CanvasUpdateReceived?.Invoke(this, new RpcDataEventArgs(data));
    public void TriggerCanvasAnalyticsUpdateReceived(byte[] data) => CanvasAnalyticsUpdateReceived?.Invoke(this, new RpcDataEventArgs(data));
}
